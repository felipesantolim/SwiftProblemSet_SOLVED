...
func median(num1: Int, num2:Int, num3: Int) -> Int {
    ...
    var middleNumber: [Int] = [num1, num2, num3]
    middleNumber.sort()
 ...
 */
func beginsWithVowel(_ text: String) -> Bool {
    
    let isVowel: Bool = false
    
    if text == "" {
        return isVowel
    }
    
    let letter: Character = text.lowercased().characters[text.startIndex]
    
    if  letter == Character("a") || letter == Character("e") ||
        letter == Character("i") || letter == Character("o") ||
        letter == Character("u")
    {
        return !isVowel
    }
 ...
 */
func funWithWords(_ text: String) -> String {
    
    var newString: String = ""
    
    if beginsWithVowel(text) {
        newString = text.uppercased()
        
    } else {
        newString = text.lowercased()
    }
